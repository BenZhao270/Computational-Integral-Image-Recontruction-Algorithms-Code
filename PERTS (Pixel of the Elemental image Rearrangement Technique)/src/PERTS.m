...
fdir = '../dataset/iso/';
lens_x = 26; % number of lenslet
lens_y = 23;
start_dep = 50;
end_dep = 50;
step_dep = 1;
pitch = 100;   % pitch of lenslet
sx = 40;     % sensor size of horizontal axis
focal_length = 40;  % focal length of main lens

%% import elemental image
infile=[fdir 'merged_image.png'];    outfile=[fdir, 'PERTS/'];
mkdir(outfile);
ei=uint8(imread(infile));  
[v h d]=size(ei);
